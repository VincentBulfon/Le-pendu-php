...
{
    $_SESSION['wordsArray'] = file(FILE_PATH, FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
    //revois l'array de mots car return avec la method file qu converti un fichier en array
}
...
function getNumberOfLetters($words)
{ //return number of letter in the word
